...
2346.times do
  ...
  Reserva.create(
    ...
    agenda_id: id_agenda = rand < percen_disponibilidad ? nil : agendas.sample.id,
    fecha: id_agenda == nil ? nil : Faker::Date.between(from: '2025-01-01', to: fecha_salida - 1),
    monto: id_agenda == nil ? nil : precio_asiento * cantidad_personas,
    cantidad_personas: id_agenda == nil ? nil : cantidad_personas,
    estado_disponibilidad: id_agenda == nil ? 'Disponible' : 'No disponible'
  )
end
...
#     monto: precio_noche * cantidad_personas,
#     cantidad_personas: cantidad_personas,
#     estado_disponibilidad: ['Disponible', 'No disponible'].sample  
#   )
# end
